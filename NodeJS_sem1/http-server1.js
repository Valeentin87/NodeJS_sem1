...
const server = http.createServer((req, res) => {
    ...
    if (req.url === '/') {
        ...
        res.end('<h1> Добро пожаловать !!! Ниже ссылка на вторую страницу</h1> <a href="http://127.0.0.1:3000/about">About</a>');                
    }
    else if (req.url === '/about') {
        res.writeHead(200, {'Content-Type':  'text/html; charset=UTF-8'});
        res.end('<h1> Добро пожаловать !!! Ниже ссылка на первую страницу</h1> <a href="http://127.0.0.1:3000/">Main</a>');                
    }
    else {
